...
public class GridHeroAdapter extends
        RecyclerView.Adapter<GridHeroAdapter.GridViewHolder>  {
         ...
         private ListHeroAdapter.ListViewHolder.OnItemClickCallback onItemClickCallback;
         public void setOnItemClickCallback(ListHeroAdapter.ListViewHolder.OnItemClickCallback onItemClickCallback) {
